...
- The backoffice API's OpenAPI document is generated with Swashbuckle, as Umbraco 17 does, and is
  served at `/umbraco/swagger/contentdashboard/swagger.json`.
...
- My Content, Scheduled and Ownership tabs in the Content section.
- Ownership is Umbraco's built-in creator field; transfers do not stamp the last-edited date.
- Administrator-only bulk hand-over of everything a departing editor owned.
